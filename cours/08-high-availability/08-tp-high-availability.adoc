...
Nous allons aussi ajouter du cache, ainsi qu'un circuit-breaker pour améliorer les performances de nos services !
...
Cliquez sur le lien suivant pour initialiser votre projet sur Github : https://classroom.github.com/a/7vjyaDk9[Github classroom,window="_blank"]
