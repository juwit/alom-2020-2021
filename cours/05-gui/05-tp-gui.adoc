...
Identifiez vous sur Github, et cliquez sur le lien suivant pour créer votre repository git: https://classroom.github.com/a/0ey65xtF[Github classroom,window="_blank"]
...
Sélectionnez l'organisation `ALOM-2020-2021`, puis votre repository, puis validez en cliquant sur `connect` :
...
.com.miage.alom.game_ui.pokemonTypes.bo.Stats
[source,java,linenums]
----
public class Stats {
}
...
[source,properties]
----
pokemonType.service.url=https://alom-pokemon-type-api.herokuapp.com  #<1>
----
